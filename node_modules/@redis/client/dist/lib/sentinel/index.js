...
class RedisSentinelClient {
    ...
    WATCH(key) {
        ...
        const watchKeys = (0, parser_1.prefixKeys)(this._self._keyPrefix, key);
        return this._execute(false, client => client.watch(watchKeys));
    }
    watch = this.WATCH;
    UNWATCH() {
        if (this._self.#clientInfo === undefined) {
...
class RedisSentinelInternal extends node_events_1.EventEmitter {
    ...
    constructor(options, sentinelClientId) {
        ...
        this.#nodeClientOptions.himportRegistry = new registry_1.FieldsetRegistry();
